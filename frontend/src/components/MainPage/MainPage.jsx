  ...
  return (
    ...
    <div className='flex items-center justify-center   '>
      <div className='flex  flex-col items-center justify-center gap-1  bg-black mx-[10rem] my-[5rem]  w-1/2 rounded-2xl shadow-2xl '>
        ...
        <span className='font-Rampart brightness-125'>
          Connect WALLET 
          </span>
        </div> 
        <div className='flex flex-col gap-5 ml-3 mr-3 p-10 w-full text-center '>
          ...
          <div className='flex   mt-3 mb-1 hover:animate-bounce bg-emerald-900	brightness-150 text-2xl hover:bg-sky-800    justify-center p-2 pl-5 pr-5 rounded-lg text-slate-300 cursor-pointer' onClick={()=>loginMin()}>
