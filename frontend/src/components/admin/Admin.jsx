  ...
  return (
    ...
    <div className=' flex flex-row justify-around'>
      <div className='flex flex-col rounded-lg shadow-xl gap-1 border-2 border-green-200 bg-green-100 p-8 pr-[10rem] pl-8'>
        ...
        <span className='text-[5rem] font-Rampart text-green-800  text-center'>{universities}</span>
      ...
      <span className='text-[5rem] font-Rampart text-green-800  text-center'>{100}</span>
        <span className='text-lg font-mono'>student count</span>
        
      </div>

    </div>
    <div className='flex m-10 justify-around gap-6 overflow-y-auto p-6 bg-green-100'>
    ...
    <div className='flex flex-col m-10 p-5 gap-5 bg-green-100'>
      <span className='text-center text-2xl font-bold font-mono'>Add University Form</span>
      <div className='  flex flex-col gap-3'>
<div className='flex  gap-3  '>
  <span className='font-mono text-xl whitespace-nowrap'>Name :   </span> 
  
         <input name='name' value={formData.name}
        onChange={handleInputChange}className='rounded-lg w-full  border border-slate-900'></input>
 
</div>
<div className='flex  gap-3  '>
  <span className='font-mono text-xl whitespace-nowrap'>Email :   </span> 
...
<div className='flex  gap-3  '>
  <span className='font-mono text-xl whitespace-nowrap'>No of Degrees :   </span> 
  
         <input   name='noOfDegree'
        value={formData.noOfDegree}
        onChange={handleInputChange}className='rounded-lg w-full  border border-slate-900'></input>
 
</div>
<div className='flex  gap-3  '>
  <span className='font-mono text-xl whitespace-nowrap'>Date of Establishment :   </span> 
...
<div className='flex  gap-3  '>
  <span className='font-mono text-xl whitespace-nowrap'>Wallet Address :   </span> 
...
<button onClick={handleSubmit}  className='bg-green-600 p-2 text-xl font-mono font-bold rounded-xl'>Submit</button>
